%Perturbed Lagrangian Multiplier Method
...
while (condition > tol)
    ...
    %K: stiffness matrix for element
    %T: tangent stiffness matrix for Element
    ...
    U =  UF_new(1:numberNodes,1);
    L = UF_new(numberNodes+NumLegrange-1:numberNodes+NumLegrange);
    iter(count) = count;
